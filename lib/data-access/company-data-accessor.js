...
class DataAccessHelper {
    ...
    async insertIntoCompany(name,currentEmployees = { employee_id: []},pastEmployees = { employee_id: []}){
        ...
        let result;
        try {
            result = await db.one(`insert into ${this.tableName}(id,name,current_employees,past_employees) values($1,$2,$3,$4) returning id`,[id,name,currentEmployees,pastEmployees]);
        } catch (error) {
            throw error;
        }
